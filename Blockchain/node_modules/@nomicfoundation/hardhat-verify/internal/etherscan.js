...
class Etherscan {
    ...
    async isVerified(address) {
        ...
        try {
            ...
            throw new errors_1.UnexpectedError(e, "Etherscan.isVerified");
        }
    }
    /**
    ...
    async verify(contractAddress, sourceCode, contractName, compilerVersion, constructorArguments) {
        ...
        const url = new URL(this.apiUrl);
        try {
            const response = await (0, undici_1.sendPostRequest)(url, parameters.toString(), {
            ...
            if (e instanceof errors_1.ContractVerificationInvalidStatusCodeError ||
                e instanceof errors_1.ContractVerificationMissingBytecodeError) {
                throw e;
            }
            throw new errors_1.UnexpectedError(e, "Etherscan.verify");
        }
    }
    /**
    ...
    async getVerificationStatus(guid) {
        ...
        try {
            ...
            if (e instanceof errors_1.ContractStatusPollingInvalidStatusCodeError ||
                e instanceof errors_1.ContractStatusPollingResponseNotOkError) {
                throw e;
            }
            throw new errors_1.UnexpectedError(e, "Etherscan.getVerificationStatus");
        }
    }
    /**
